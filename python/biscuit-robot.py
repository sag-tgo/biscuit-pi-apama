...
TOUCH_SENSOR1_PORT = bp.PORT_3  # limit sensor
TOUCH_SENSOR2_PORT = bp.PORT_4  # e-stop sensor
GYRO_SENSOR_PORT = bp.PORT_2    # arm angle/height
COLOUR_SENSOR_PORT = bp.PORT_1  # biscuit colour

# Configure motor/port mappings
MOTOR_ARM_GRABBER = bp.PORT_A
MOTOR_ARM_VERTICAL = bp.PORT_B
MOTOR_ARM_ROTATE   = bp.PORT_C

# Configure BrickPi sensors
bp.set_sensor_type(TOUCH_SENSOR1_PORT, bp.SENSOR_TYPE.EV3_TOUCH)
bp.set_sensor_type(GYRO_SENSOR_PORT, bp.SENSOR_TYPE.EV3_GYRO_ABS_DPS)
bp.set_sensor_type(COLOUR_SENSOR_PORT, bp.SENSOR_TYPE.EV3_COLOR_COLOR)
